...
transTopDef x = case x of
  ...
  AbsLatte.TopClassDef _ ident classmembers -> failure x
  AbsLatte.TopClassDefWithInher _ ident1 ident2 classmembers -> failure x
...
transClassMember x = case x of
  ...
  AbsLatte.Method _ fndef -> failure x
...
transExpr x = case x of
  ...
  AbsLatte.ECast _ type_ expr -> failure x
  AbsLatte.ENewObject _ type_ -> failure x
  AbsLatte.ENewArray _ type_ expr -> failure x
  AbsLatte.EApp _ expr exprs -> failure x
  AbsLatte.EMember _ expr ident -> failure x
