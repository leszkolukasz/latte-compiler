...
instance Print (AbsLatte.TopDef' a) where
  prt i = \case
    ...
    AbsLatte.TopClassDef _ id_ classmembers -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id_, doc (showString "{"), prt 0 classmembers, doc (showString "}")])
    AbsLatte.TopClassDefWithInher _ id_1 id_2 classmembers -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id_1, doc (showString "extends"), prt 0 id_2, doc (showString "{"), prt 0 classmembers, doc (showString "}")])
...
instance Print (AbsLatte.ClassMember' a) where
  prt i = \case
    ...
    AbsLatte.Method _ fndef -> prPrec i 0 (concatD [prt 0 fndef])
...
instance Print (AbsLatte.Expr' a) where
  prt i = \case
    ...
    AbsLatte.ELitNull _ -> prPrec i 7 (concatD [doc (showString "null")])
    ...
    AbsLatte.ECast _ type_ expr -> prPrec i 7 (concatD [doc (showString "cast<"), prt 0 type_, doc (showString ">"), doc (showString "("), prt 0 expr, doc (showString ")")])
    AbsLatte.ENewObject _ type_ -> prPrec i 7 (concatD [doc (showString "new"), prt 0 type_])
    AbsLatte.ENewArray _ type_ expr -> prPrec i 7 (concatD [doc (showString "new"), prt 0 type_, doc (showString "["), prt 0 expr, doc (showString "]")])
    AbsLatte.EApp _ expr exprs -> prPrec i 6 (concatD [prt 6 expr, doc (showString "("), prt 0 exprs, doc (showString ")")])
    AbsLatte.EMember _ expr id_ -> prPrec i 6 (concatD [prt 6 expr, doc (showString "."), prt 0 id_])
